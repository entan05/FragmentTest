...
/**
 * 異なる重なるViewGroupでの複数Fragment
 */
public class FragmentTest04Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragment_test04);

        final CheckBox clearCheck = (CheckBox)findViewById(R.id.fragment_test04_isClear);
        ...
        switch01.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    transaction.add(R.id.Fragment_test04_container01, mFragment01);
        ...
        switch02.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    transaction.add(R.id.Fragment_test04_container02, mFragment02);
